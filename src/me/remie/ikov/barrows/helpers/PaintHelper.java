package me.remie.ikov.barrows.helpers;
...
/**
 * Created by Reminisce on Feb 14, 2023 at 11:25 PM
 *
...
public class PaintHelper extends ClientAccessor<ClientContext> {
     ...
     */
    public PaintHelper(final BarrowsScript script) {
        super(script.ctx);
        this.script = script;
     ...
     * This method is called by the {@link BarrowsScript#onPaint(Graphics2D)} method.
     *
     ...
     * This method is called by the {@link BarrowsScript#mouseClicked(MouseEvent)} method.
     *
